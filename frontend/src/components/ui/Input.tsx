...
export default function Input({ label, error, hint, icon: Icon, id, className = "", ...props }: Props) {
  return (
        ...
        <input
          ...
          className={[
            ...
            error
              ...
              : "border-[var(--color-border) focus:ring-[var(--color-primary)/15 focus:border-[var(--color-primary) focus:bg-white",
            Icon ? "pl-10" : "pl-4",
            className,
          ].join(" ")}
          {...props}
